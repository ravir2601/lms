...
(function($) {
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			 ...
			 * default, returning result will be in a application-list of <td>.
			 * @param tablePart
			...
			getOneRow: function(tablePart, row, tdOnly) {
				...
				// get application-list of <tr>
				var result = $(tablePart).find('.' + pfx + 'datatable__row:not(.' + pfx + 'datatable__row-detail):nth-child(' + row + ')');
				if (tdOnly) {
					// get application-list of <td> or <th>
			...
			/**
			 * Update JSON data application-list linked with sort, filter and pagination.
			 ...
			 * @param value
			 * @param columns. Optional application-list of columns to be filtered.
			 */
