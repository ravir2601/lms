import { QuickPanelComponent } from './../../partials/layout/quick-panel/quick-panel.component';
// Angular
...
export class BaseComponent implements OnInit, OnDestroy {
    @ViewChild(QuickPanelComponent, {static: false})
    openSummary: QuickPanelComponent;
    ...
    // open summary view
    toggleSummary(id, source?) {
        this.openSummary.getSummary(id, source);
    }
